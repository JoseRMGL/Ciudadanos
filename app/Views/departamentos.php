      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="<?php echo base_url('ver_niveles_academicos');?>">Niveles Academicos</a></li>
    ...
    <div class="container">
        ...
        <table class="table table-border table-striped">
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td><?php echo $nivelesAdacemicos['cod_depto'];?></td>
                    <td><?php echo $nivelesAdacemicos['nombre_depto'];?></td>
                    <td><?php echo $nivelesAdacemicos['cod_region'];?></td>
                </tr>
                <?php
                    endforeach;
                ?>
